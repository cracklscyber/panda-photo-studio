...
export default function RomyLanding() {
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#0A0A0F]/80 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold">Romy</span>
          </div>
      ...
      <section className="relative pt-32 pb-20 px-6">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <p className="mt-6 text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
            Romy erstellt und verwaltet deine Website, schreibt Angebote und generiert PDFs —
            alles per WhatsApp-Nachricht. Du schreibst, Romy macht den Rest.
          </p>
          ...
          <div className="mt-16 max-w-md mx-auto">
            <div className="bg-[#111118] border border-white/10 rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="bg-[#1A1A25] px-4 py-3 flex items-center gap-3 border-b border-white/5">
                ...
                <div>
                  <div className="font-semibold text-sm">Romy</div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-[#111118] border border-white/5 rounded-2xl p-8 hover:border-violet-500/30 transition-colors group">
              ...
              <p className="text-gray-400 leading-relaxed">
                Romy baut deine professionelle Website. Öffnungszeiten ändern, neues Bild hochladen,
            ...
            <div className="bg-[#111118] border border-white/5 rounded-2xl p-8 hover:border-blue-500/30 transition-colors group">
              ...
              <p className="text-gray-400 leading-relaxed">
                ...
                Romy schreibt den Text, veröffentlicht das Angebot auf deiner Website und hält alles aktuell.
              </p>
            </div>
            ...
            <div className="bg-[#111118] border border-white/5 rounded-2xl p-8 hover:border-emerald-500/30 transition-colors group">
              ...
              <p className="text-gray-400 leading-relaxed">
                Angebotsflyer, Preislisten, Aktionen — Romy erstellt professionelle PDFs
          ...
          <div className="space-y-12">
            <div className="flex items-start gap-6">
              ...
              <div>
                ...
                <p className="text-gray-400 leading-relaxed">
                  Name und Handynummer — mehr braucht Romy nicht.
                  Du bekommst sofort eine WhatsApp-Nachricht von Romy.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2">Erzähl Romy von deinem Geschäft</h3>
                <p className="text-gray-400 leading-relaxed">
                  Romy fragt per WhatsApp nach deinem Geschäftsnamen, Angeboten,
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                ...
                <p className="text-gray-400 leading-relaxed">
                  ...
                  Änderungen? Schreib Romy einfach eine Nachricht.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-lg mx-auto relative">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-400 text-lg">
              Trag dich ein und Romy meldet sich sofort bei dir auf WhatsApp.
            </p>
          </div>
          ...
          {formState === 'success' ? (
            <div className="bg-[#111118] border border-green-500/30 rounded-2xl p-8 text-center">
              ...
              <p className="text-gray-400">
                Romy meldet sich gleich bei dir auf WhatsApp. Schau auf dein Handy!
              </p>
            </div>
          ) : (
      ...
      <footer className="border-t border-white/5 py-12 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold">Romy</span>
          </div>
          ...
          <p className="text-gray-600 text-sm">
            &copy; 2026 Romy. Alle Rechte vorbehalten.
          </p>
        </div>
      </footer>
    </div>
