...
export default function Home() {
  return (
    <main className="min-h-screen overflow-hidden text-[#0b0b13]" style={{ background: '#f1f2f9' }}>
      ...
      {/* Hero */}
      <section
        className="relative flex min-h-[calc(100vh-73px)] items-center justify-center px-5 py-16 sm:px-10"
        style={{
          background: 'linear-gradient(145deg, #f0fdf9 0%, #d0f5ee 35%, #2dc4b5 75%, #1aada0 100%)',
        }}
      >
        <div
          className="relative mx-auto w-full max-w-[640px] rounded-[36px] px-8 py-16 text-center sm:px-16 sm:py-[88px]"
          style={{
            background: 'rgba(255,255,255,0.52)',
            backdropFilter: 'blur(28px) saturate(1.4)',
            WebkitBackdropFilter: 'blur(28px) saturate(1.4)',
            border: '1px solid rgba(255,255,255,0.72)',
            boxShadow: '0 8px 52px rgba(0,0,0,0.07), inset 0 1px 0 rgba(255,255,255,0.92)',
          }}
        >
          <p
            className="mb-6 text-[15px] font-medium tracking-wide"
            style={{ color: '#999' }}
          >
            Entdecke
          </p>
          ...
          <h1
            className="mb-12 text-[clamp(34px,9vw,62px)] font-black leading-[1.05] tracking-[-0.055em]"
          ...
          >
            ...
            erstellen.
            <br />
            <em style={{ color: '#2dc4b5', fontStyle: 'italic' }}>Einfach</em>
            {' '}per WhatsApp.
          </h1>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex h-[54px] w-[54px] items-center justify-center rounded-full transition hover:scale-110 active:scale-95"
            style={{ background: '#2dc4b5', boxShadow: '0 8px 24px rgba(45,196,181,0.45)' }}
